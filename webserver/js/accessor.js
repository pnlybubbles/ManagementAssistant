...
Accessor.prototype = {
  initialize: function(call_func_receiver) {
    ...
    this.ws.onopen = function(event) {
      ...
      self.tell(req);
      if(self.call_func_receiver["accessor_load"]) {
        self.call_func_receiver["accessor_load"].apply(self.call_func_receiver, []);
      }
    };
    ...
    this.ws.onclose = function(event) {
      ...
      if(self.call_func_receiver["accessor_close"]) {
        self.call_func_receiver["accessor_close"].apply(self.call_func_receiver, []);
      }
    };
    this.ws.onerror = function(event) {
      console.log("error");
      if(self.call_func_receiver["accessor_error"]) {
        self.call_func_receiver["accessor_error"].apply(self.call_func_receiver, []);
      }
    };
  },
